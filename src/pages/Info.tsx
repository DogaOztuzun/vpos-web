...
import { AppIcon, DiscordIcon, GitbookIcon, GitIcon, PosDemonstration, PoweredByAvalanche, VposDemonstration } from "../assets";
        ...
        <Stack w='100vw' h='100vh' pt='120px' overflowWrap='anywhere'>
            <Flex h='100px' justify='center' color='currentColor' bgColor={colorMode === 'light' ? 'white' : '#1A202C'} w='100%' position='fixed' top={0} zIndex={3} p={4} borderBottom='1px solid'>
                <Flex maxW='620px' w='100%' justify='space-between' align='center'>
                    <Heading size='lg'><AppIcon style={{ marginRight: '.7rem' }} height='50px' width='50px' />vPos</Heading>
                    <Flex gap={4}>
            ...
            <Stack w='100%' justify='center' align='center' position='absolute' top='100px' pt={5}>
                <Stack textAlign='center' spacing={10} align='center' pb={10}>
                    ...
                    <Flex gap={4} p={4} wrap='wrap' justify='center'>
                        ...
                        <Button as={Link} isExternal href='https://github.com/ElementalDao' leftIcon={<GitIcon height='auto' width='40px' />}>
                            Github
                        </Button>
                        <Button as={Link} isExternal href='https://discord.gg/QY3PpjZKzk' leftIcon={<DiscordIcon height='auto' width='40px' />}>
                            Discord
                        </Button>
                    </Flex>
