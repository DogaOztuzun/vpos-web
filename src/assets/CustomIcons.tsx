...
export function MixerIcon(props: any) {
    return (
        <Icon viewBox="0 0 64 64" fill='currentColor' {...props}>
            <path d="m17.172 26.146 1.414 1.414c.756-.756 2.072-.756 2.828 0l1.414-1.414c-1.511-1.511-4.145-1.511-5.656 0z" />
            <path d="m14.343 23.318 1.414 1.414c1.133-1.134 2.64-1.758 4.243-1.758s3.109.624 4.243 1.758l1.414-1.414c-1.511-1.512-3.52-2.344-5.657-2.344s-4.146.833-5.657 2.344z" />
            <path d="m11.515 20.489 1.414 1.414c3.899-3.898 10.243-3.898 14.143 0l1.414-1.414c-4.679-4.677-12.293-4.677-16.971 0z" />
            <path d="m58 9h-52c-2.757 0-5 2.243-5 5v36c0 2.757 2.243 5 5 5h52c2.757 0 5-2.243 5-5v-36c0-2.757-2.243-5-5-5zm3 41c0 1.654-1.346 3-3 3h-52c-1.654 0-3-1.346-3-3v-36c0-1.654 1.346-3 3-3h52c1.654 0 3 1.346 3 3z" />
            ...
            <path d="m40 45c-1.654 0-3 1.346-3 3s1.346 3 3 3 3-1.346 3-3-1.346-3-3-3zm0 4c-.551 0-1-.448-1-1s.449-1 1-1 1 .448 1 1-.449 1-1 1z" />
            <path d="m53 43h6v-6h-6zm2-4h2v2h-2z" />
            <path d="m45 43h6v-6h-6zm2-4h2v2h-2z" />
            <path d="m37 43h6v-6h-6zm2-4h2v2h-2z" />
            <path d="m53 35h6v-6h-6zm2-4h2v2h-2z" />
            <path d="m45 35h6v-6h-6zm2-4h2v2h-2z" />
            <path d="m37 35h6v-6h-6zm2-4h2v2h-2z" />
            <path d="m53 27h6v-6h-6zm2-4h2v2h-2z" />
            <path d="m45 27h6v-6h-6zm2-4h2v2h-2z" />
            <path d="m37 27h6v-6h-6zm2-4h2v2h-2z" />
            <path d="m57 13h-18c-1.103 0-2 .897-2 2v2c0 1.103.897 2 2 2h18c1.103 0 2-.897 2-2v-2c0-1.103-.897-2-2-2zm-18 4v-2h18l.001 2z" />
            <path d="m33 13h-26c-1.103 0-2 .897-2 2v16c0 1.103.897 2 2 2h26c1.103 0 2-.897 2-2v-16c0-1.103-.897-2-2-2zm-26 18v-16h26l.001 16z" />
            <path d="m33 35h-8c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h8c1.103 0 2-.897 2-2v-12c0-1.103-.897-2-2-2zm-8 14v-12h8l.001 12z" />
        </Icon>
    )
}
...
export function SettingsIcon(props: any) {
    return (
        <Icon viewBox="0 0 512 512" fill='currentColor' {...props}>
            <path d="M500.23,270.051h-74.54V212.66c0-6.501-5.271-11.77-11.77-11.77h-48.1l27.688-47.958l64.046,36.977
            ...
            <path d="M149.677,438.952H148.5c-6.499,0-11.77,5.269-11.77,11.77s5.271,11.77,11.77,11.77h1.177
				c6.499,0,11.77-5.269,11.77-11.77S156.176,438.952,149.677,438.952z"/>
            <path d="M362.323,462.492h1.177c6.499,0,11.77-5.269,11.77-11.77s-5.271-11.77-11.77-11.77h-1.177
...
export function QrIcon(props: any) {
    return (
        <Icon viewBox="0 0 1000 1000" fill='currentColor' {...props}>
            <g>
                ...
                <path d="M585.2,316.3h83.3c3.9,0,7.8,1.5,10.8,4.5c3,3,4.5,6.9,4.5,10.8v99.5c0,8.5,6.8,15.3,15.3,15.3s15.3-6.9,15.3-15.3V316.3c0-7.8-3-15.7-9-21.7c-6-6-13.8-9-21.7-9h-98.6c-8.5,0-15.3,6.9-15.3,15.3S576.7,316.3,585.2,316.3z" />
                <path d="M699.1,553.6c-8.5,0-15.3,6.8-15.3,15.3v99.5c0,3.9-1.5,7.8-4.5,10.8s-6.9,4.5-10.8,4.5h-83.3c-8.5,0-15.3,6.8-15.3,15.3s6.8,15.3,15.3,15.3h98.6c7.8,0,15.7-3,21.7-9c6-6,9-13.8,9-21.7V568.9C714.4,560.4,707.5,553.6,699.1,553.6z" />
                <path d="M300.9,446.4c8.5,0,15.3-6.9,15.3-15.3v-99.5c0-3.9,1.5-7.8,4.5-10.8c3-3,6.9-4.5,10.8-4.5h84.2c8.5,0,15.3-6.9,15.3-15.3s-6.9-15.3-15.3-15.3h-99.5c-7.8,0-15.7,3-21.7,9c-6,6-9,13.8-9,21.7v114.8C285.6,439.5,292.5,446.4,300.9,446.4z" />
                <path d="M415.8,683.8h-84.2c-3.9,0-7.8-1.5-10.8-4.5c-3-3-4.5-6.9-4.5-10.8v-99.5c0-8.5-6.9-15.3-15.3-15.3s-15.3,6.8-15.3,15.3v114.8c0,7.8,3,15.7,9,21.7c6,6,13.8,9,21.7,9h99.5c8.5,0,15.3-6.8,15.3-15.3S424.2,683.8,415.8,683.8z" />
                <path d="M714.4,484.7H285.6c-8.5,0-15.3,6.9-15.3,15.3c0,8.5,6.9,15.3,15.3,15.3h428.8c8.5,0,15.3-6.8,15.3-15.3C729.7,491.5,722.8,484.7,714.4,484.7z" />
            </g>
        </Icon>
    )
}
