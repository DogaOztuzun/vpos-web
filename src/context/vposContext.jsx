...
import fiatluxContract from '../contracts/fiatLux.json'
import { useAccount } from 'wagmi'
import { useDispatch } from 'react-redux'
import { setAlertSuccess, setAlertWarning } from '../reducers'

const VposContext = createContext()

export const VposProvider = ({ children }) => {
    ...
    */
    ...
    return (
        <VposContext.Provider value={contextData}>
            {children}
        </VposContext.Provider>
    )
}

export const useVposContext = () => useContext(VposContext)
